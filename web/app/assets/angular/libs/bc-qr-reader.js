...
bcQrReader = function($timeout) {
  return {
    ...
    template: '<div><webcam on-stream="onStream(stream)" on-error="onError(err)" ng-if="active" channel="channel"></webcam><canvas id="qr-canvas" style="display: none"></canvas></div>',
